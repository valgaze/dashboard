...
function SidebarMenu(props) {
  ...
  return (
    <div >
      ...
      <ul className={["1HfvtFz4fZ5dEMw96uD1we", "6wkQroQQA8HiMlPenCuyeI", "1RCEwpLcHhkZUVfSIwOyAa", "2SUEzcvWJKO4EipyEuwwo1"].indexOf(organizationId) > -1 ? "sidebar-nav-list" : "hide"}>
        <li className="list-header">
