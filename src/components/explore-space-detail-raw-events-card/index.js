  ...
  render() {
    ...
    return <div>
      <Card className="explore-space-detail-raw-events-card">
        ...
        {view === EMPTY ? <div className="explore-space-detail-raw-events-card-body-info">
          No data available for this time period.
        </div> : null}
        {view === LOADING ? <div className="explore-space-detail-raw-events-card-body-info">
          Fetching events...
        </div> : null}
        {view === ERROR ? <div className="explore-space-detail-raw-events-card-body-error">
          <span>
