...
describe('Space update modal', function() {
  it('should render a space update modal (smoke test)', function() {
    ...
    assert.equal(component.find('.visualization-space-detail-space-update-modal').length, 1);
  });
  ...
  it('should have proper ui interactions and create a reset', async function() {
    ...
    let value = component.find('.visualization-space-detail-space-update-modal-count-picker-label input').prop('value');
    assert.equal(value, '5');

    // Click the add button
    component.find('.visualization-space-detail-space-update-modal-count-button.add').simulate('click');

    // The current count is one larger.
    value = component.find('.visualization-space-detail-space-update-modal-count-picker-label input').prop('value');
    assert.equal(value, '6');

    // Click the subtract button, twice
    component.find('.visualization-space-detail-space-update-modal-count-button.subtract').simulate('click');
    component.find('.visualization-space-detail-space-update-modal-count-button.subtract').simulate('click');
    ...
    component.find('.visualization-space-detail-space-update-modal-reset-count').simulate('click');
    ...
    component.find('.visualization-space-detail-space-update-modal-count-picker-label input').simulate('change', {target: {value: '100'}});
    component.find('.visualization-space-detail-space-update-modal-count-picker-label input').simulate('blur');
    ...
    component.find('.visualization-space-detail-space-update-modal-count-picker-label input').simulate('change', {target: {value: '10.2'}});
    component.find('.visualization-space-detail-space-update-modal-count-picker-label input').simulate('blur');
    ...
    component.find('.visualization-space-detail-space-update-modal-count-picker-label input').simulate('change', {target: {value: 'abc'}});
    component.find('.visualization-space-detail-space-update-modal-count-picker-label input').simulate('blur');
    ...
    component.find('.visualization-space-detail-space-update-modal-submit').simulate('click');
