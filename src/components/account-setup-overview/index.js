      ...
      <div className="account-setup-overview-body-container">
        ...
        <Card className="account-setup-overview-body">
          <CardBody>
            ...
            <Button className="account-setup-submit" onClick={onGetStarted}>Lets Get Started</Button>
          </CardBody>
        </Card>
      </div>
    </div>;
  } else if (user.loading) {
    return <div className="account-detup-overview account-setup-overview-loading">
